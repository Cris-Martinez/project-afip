...
class CreateCategoriaIvasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('categoria_ivas', function (Blueprint $table) {
            $table->bigIncrements('id');

			$table->string('nombre')->unique()->comment('nombre:string:80:fillable:unique');
			$table->char('discrimina')->comment('discrimina:char:1');
    ...
    {
        Schema::dropIfExists('categoria_ivas');
    }
}
